...
for d in research_dir.iterdir():
    if (
        ...
        and not d.name.startswith('assets')
    ):
...
### [Minification Tools Compared](https://github.com/scottj/agent-research/tree/main/minifier-options#readme) (2026-05-03 22:57)
...
### [Rust GUI Options for Windows](https://github.com/scottj/agent-research/tree/main/rust-windows-gui-research#readme) (2026-04-18 02:45)
